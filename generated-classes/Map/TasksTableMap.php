...
class TasksTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.TasksTableMap';
     ...
     */
    const OM_CLASS = '\\Tasks';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Tasks';
     ...
     */
    const COL_CHECK = 'tasks.check';

    /**
     * the column name for the task field
     */
    const COL_TASK = 'tasks.task';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Check', 'Task', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'check', 'task', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(TasksTableMap::COL_ID, TasksTableMap::COL_CHECK, TasksTableMap::COL_TASK, TasksTableMap::COL_CREATED_AT, TasksTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'check', 'task', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Check' => 1, 'Task' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'check' => 1, 'task' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(TasksTableMap::COL_ID => 0, TasksTableMap::COL_CHECK => 1, TasksTableMap::COL_TASK => 2, TasksTableMap::COL_CREATED_AT => 3, TasksTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'check' => 1, 'task' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('check', 'Check', 'BOOLEAN', true, 1, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TasksTableMap::COL_CHECK);
            $criteria->addSelectColumn(TasksTableMap::COL_TASK);
            $criteria->addSelectColumn(TasksTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(TasksTableMap::COL_UPDATED_AT);
        } else {
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(TasksTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(TasksTableMap::TABLE_NAME)) {
