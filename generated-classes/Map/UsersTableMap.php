...
class UsersTableMap extends TableMap
{
    ...
    /**
     * the column name for the id_ext field
     */
    const COL_ID_EXT = 'users.id_ext';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'IdExt', 'Email', 'Password', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'idExt', 'email', 'password', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_ID_EXT, UsersTableMap::COL_EMAIL, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_CREATED_AT, UsersTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'id_ext', 'email', 'password', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'IdExt' => 1, 'Email' => 2, 'Password' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'idExt' => 1, 'email' => 2, 'password' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_ID_EXT => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_PASSWORD => 3, UsersTableMap::COL_CREATED_AT => 4, UsersTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'id_ext' => 1, 'email' => 2, 'password' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('id_ext', 'IdExt', 'VARCHAR', true, 64, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_ID_EXT);
            ...
            $criteria->addSelectColumn($alias . '.id_ext');
