 ...
 * @method     ChildUsersQuery orderByIdExt($order = Criteria::ASC) Order by the id_ext column
 ...
 * @method     ChildUsersQuery groupByIdExt() Group by the id_ext column
 ...
 * @method     ChildUsers findOneByIdExt(string $id_ext) Return the first ChildUsers filtered by the id_ext column
 ...
 * @method     ChildUsers requireOneByIdExt(string $id_ext) Return the first ChildUsers filtered by the id_ext column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUsers[]|ObjectCollection findByIdExt(string $id_ext) Return ChildUsers objects filtered by the id_ext column
...
abstract class UsersQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'maindatabase', $modelName = '\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `id_ext`, `email`, `password`, `created_at`, `updated_at` FROM `users` WHERE `id` = :p0';
        try {
    ...
    /**
     * Filter the query on the id_ext column
     *
     * Example usage:
     * <code>
     * $query->filterByIdExt('fooValue');   // WHERE id_ext = 'fooValue'
     * $query->filterByIdExt('%fooValue%', Criteria::LIKE); // WHERE id_ext LIKE '%fooValue%'
     * </code>
     *
     * @param     string $idExt The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildUsersQuery The current query, for fluid interface
     */
    public function filterByIdExt($idExt = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($idExt)) {
                $comparison = Criteria::IN;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_ID_EXT, $idExt, $comparison);
    }
