...
abstract class Tasks implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TasksTableMap';
     ...
     *
     * @return $this|Tasks The current object, for fluid interface
     */
     ...
     * @return $this|\Tasks The current object (for fluent API support)
     */
    ...
    public function setCheck($v)
    {
        ...
        if ($this->check !== $v) {
            $this->check = $v;
            $this->modifiedColumns[TasksTableMap::COL_CHECK] = true;
        }
    ...
    public function setTask($v)
    {
        ...
        if ($this->task !== $v) {
            $this->task = $v;
            $this->modifiedColumns[TasksTableMap::COL_TASK] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TasksTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TasksTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TasksTableMap::translateFieldName('Check', TableMap::TYPE_PHPNAME, $indexType)];
            $this->check = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TasksTableMap::translateFieldName('Task', TableMap::TYPE_PHPNAME, $indexType)];
            $this->task = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TasksTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TasksTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = TasksTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TasksTableMap::COL_CHECK)) {
            $modifiedColumns[':p' . $index++]  = '`check`';
        }
        if ($this->isColumnModified(TasksTableMap::COL_TASK)) {
            $modifiedColumns[':p' . $index++]  = '`task`';
        }
        if ($this->isColumnModified(TasksTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(TasksTableMap::COL_UPDATED_AT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TasksTableMap::COL_CHECK)) {
            $criteria->add(TasksTableMap::COL_CHECK, $this->check);
        }
        if ($this->isColumnModified(TasksTableMap::COL_TASK)) {
            $criteria->add(TasksTableMap::COL_TASK, $this->task);
        }
        if ($this->isColumnModified(TasksTableMap::COL_CREATED_AT)) {
            $criteria->add(TasksTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(TasksTableMap::COL_UPDATED_AT)) {
            $criteria->add(TasksTableMap::COL_UPDATED_AT, $this->updated_at);
        }
